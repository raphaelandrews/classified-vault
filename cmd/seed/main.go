...
func main() {
	...
	scrolls := []scroll{
...

		{
			...
			domain.TierPublic, domain.DepartmentBulletinBoard, "",
...

		{
			...
			domain.TierJunimo, domain.DepartmentMayorsOffice, "",
		...
		},
		{
			...
			"Fiscal allocation for the current year:\n\n| Category | Amount | Status |\n|---|---|---|\n| Town Hall maintenance | 12,000g | Approved |\n| Festival organization | 8,500g | Approved |\n| Road and bridge repair | 6,200g | Approved |\n| Community Center restoration | 4,000g | Pending |\n| Emergency reserves | 3,300g | Locked |\n\n**Total: 34,000g**\n\n> The Community Center restoration fund requires matching donations from the Junimos before release.",
			domain.TierCorporate, domain.DepartmentMayorsOffice, "",
		...
		},
		{
			...
			domain.TierGuild, domain.DepartmentMayorsOffice, "",
		...
		},
		{
			...
			domain.TierCouncil, domain.DepartmentMayorsOffice, "",
			[]string{"infrastructure", "renovation"}, nil, "lewis",
		},

		// =========================================================================
		// "Secret Notes" folder (Mayor's Office + Qi's Office — cross-department)
		// =========================================================================

		{
			...
			domain.TierJunimo, domain.DepartmentMayorsOffice, "Secret Notes",
		...
		},
		{
			...
			domain.TierCorporate, domain.DepartmentQisOffice, "Secret Notes",
...

		{
			...
			domain.TierArcane, domain.DepartmentWizardsTower, "",
		...
		},
		{
			...
			domain.TierCorporate, domain.DepartmentWizardsTower, "",
...

		{
			...
			domain.TierCorporate, domain.DepartmentJojaCorp, "",
		...
		},
		{
			...
			domain.TierGuild, domain.DepartmentJojaCorp, "",
...

		{
			...
			domain.TierGuild, domain.DepartmentAdventurersGuild, "",
			[]string{"monsters", "mine", "safety"}, nil, "marlon",
		},
		{
			"Skull Cavern Expedition: Level 100",
			"Expedition log from the most recent descent into Skull Cavern.\n\n**Start:** Floor 1 — 6:00 AM\n**End:** Floor 103 — 2:30 AM (emergency totem extraction)\n\n## Findings\n\n- **12 Iridium nodes** located between floors 85–99\n- **4 Treasure Rooms** discovered (floors 22, 47, 68, 95)\n- **3 Prismatic Shards** recovered\n\n## Encounters\n\n- Multiple **Serpents** (floors 30+)\n- One **Mummy Floor** (level 76) — used *5 Mega Bombs* to clear\n- Iridium Bats at level 100+\n\n## Equipment Used\n\n- Galaxy Sword (forged with 3 Ruby)\n- Iridium Band + Slime Charmer Ring\n- 47 plates of Sashimi\n\n**Qi's evaluation pending.**",
			domain.TierGuild, domain.DepartmentAdventurersGuild, "",
		...
		},
		{
			...
			domain.TierCouncil, domain.DepartmentAdventurersGuild, "",
...

		{
			...
			domain.TierGuild, domain.DepartmentHarveysClinic, "",
		...
		},
		{
			...
			domain.TierCouncil, domain.DepartmentHarveysClinic, "",
...

		{
			...
			domain.TierCouncil, domain.DepartmentCommunityCenter, "",
...

		{
			...
			domain.TierCouncil, domain.DepartmentCarpentersShop, "",
		...
		},
		{
			...
			domain.TierPublic, domain.DepartmentCarpentersShop, "",
...

		{
			...
			domain.TierPublic, domain.DepartmentMuseum, "",
...

		{
			...
			domain.TierPublic, domain.DepartmentBulletinBoard, "War of the Worlds Broadcast",
		...
		},
		{
			...
			domain.TierCouncil, domain.DepartmentBulletinBoard, "War of the Worlds Broadcast",
		...
		},
		{
			...
			"[QI INVESTIGATION — TIER 4]\n\nWeekly compilation of anomalous events across Stardew Valley:\n\n## Monday\nThree **Void Chickens** escaped Krobus's sewer enclosure. Recovered near the Mountain Lake. No injuries.\n\n## Tuesday\nForest spirits (Junimos) observed carrying a **golden walnut** toward the abandoned Farm. Purpose unknown.\n\n## Wednesday\nEarthquake detected at **1:22 AM**, magnitude 2.4. Epicenter: Mines Level 0 entrance. A boulder blocking the Railroad bath house was destroyed by the tremor. Coincidence?\n\n## Thursday\nThe Traveling Merchant's cart arrived with a *rare* artifact — an Ancient Seed inside a clay pot. The Museum authenticated it. The cart's pig was wearing a fez.\n\n## Friday\nA **mermaid** was sighted on the Beach at midnight during rain. The Wizard confirms merpeople presence in the Gem Sea. She was singing a tune that translated roughly to *\"plant blueberries in summer.\"*\n\n## Saturday\n3 Prismatic Shards recovered from Skull Cavern by a local farmer using only a stone pickaxe and 47 plates of sashimi. This farmer's luck stat **defies statistical modeling**.\n\n> **WEEKLY ASSESSMENT**: Paranormal baseline remains elevated but stable. No hostile activity detected.",
			domain.TierArcane, domain.DepartmentQisOffice, "X-Files: Qi's Investigations",
...

		{
			...
			domain.TierCouncil, domain.DepartmentPierDocks, "The Legendary Fish",
		...
		// =========================================================================
		// SUPERNATURAL & EASTER EGGS — Various departments
		// =========================================================================
...

		{
			...
			"[FALL 16TH — GRANGE DISPLAY CONTEST]\n\n## Official Results\n\n| Place | Entrant | Points | Display |\n|---|---|---|---|\n| 🥇 1st | Willow Lane Farm | **98** | 9 Iridium Ancient Fruit, 3 Truffle Oils, 1 Prismatic Shard, 1 Golden Pumpkin, 1 Rabbit's Foot |\n| 🥈 2nd | Pierre's General Store | 72 | Vegetables and artisan goods. Solid but missing *\"the wow factor.\"* |\n| 🥉 3rd | Marnie's Ranch | 65 | Animal products. Lost points for hay in the presentation. |\n| 💥 DQ | JojaMart | 0 | Joja Cola pyramid. Collapsed. Covered Mayor Lewis in cola. Removed from premises. |\n\n> *\"This is the finest grange I have seen in my 20 years as Mayor.\"* — Lewis\n\n## Judges\n\n- Mayor Lewis (Head Judge)\n- Robin (Craftsmanship)\n- Gus (Culinary)\n- Harvey (Health & Safety)\n\n**Next year's theme:** *Under the Sea.*",
			domain.TierPublic, domain.DepartmentBulletinBoard, "",
			[]string{"event", "contest", "fall", "grange"}, nil, "gus",
		},
		{
			"Ice Fishing Competition — Winter Year 2 Final Standings",
			"[WINTER 8TH — ICE FISHING COMPETITION]\n\n## Final Standings\n\n| Rank | Angler | Fish | Notes |\n|---|---|---|---|\n| 🥇 1st | **Willy** | 18 | Won with a last-minute Lingcod. Prize: 2,000g + engraved tackle box |\n| 🥈 2nd | Willow Lane Farmer | 15 | Dressed Spinners + Cork Bobbers. Line froze in final 10 min |\n| 🥉 3rd | **Pam** | 7 | Fished with bamboo pole while drinking Pale Ale. Legendary. |\n| 4th | Linus | 5 | Caught all with bare hands. Refused prize: *\"The mountain needs no trophies.\"* |\n| DFL | Mayor Lewis | 1 | The \"fish\" was a 3 cm driftwood splinter. Blamed \"bad ice\" and \"sabotage by Pierre.\" |\n\n> Ice thickness: 22 cm. Safety standards met.",
			domain.TierPublic, domain.DepartmentPierDocks, "",
